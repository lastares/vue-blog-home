      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body" data-validator-form>
          <div class="form-group">
            <label class="control-label">手机 or 邮箱</label>
            <input v-model.trim="username" type="text" class="form-control" placeholder="请填写用户名">
            <!--<input v-model.trim="username" v-validator.required="{ title: '用户名' }" type="text" class="form-control" placeholder="请填写用户名">-->
          </div>
          <div class="form-group">
            <label class="control-label">密 码</label>
            <input v-model.trim="password" id="password" type="password" class="form-control" placeholder="请填写密码">
